  ...
  return (
    <>
      <div className="flex flex-col   items-center     w-full h-[4000px] lg:h-[1100px] bg-gradient-to-r from-zinc-800 to-zinc-900 p-4 gap-4 ">
        <h1 className="text-white text-3xl uppercase mb-8 font-bold">Projetos</h1>
        <div className="grid grid-cols-1 border-2 lg:grid-cols-4 lg:justify-items-center   w-full   gap-4">
          <div className="card flex flex-col w-[300px] h-[420px] border-2 cursor-pointer hover:border-fuchsia-600 duration-300 ease-in-out bg-zinc-900 rounded-md items-center p-4  mt-4 gap-4 ">
